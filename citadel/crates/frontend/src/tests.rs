#[cfg(test)]
mod tests {
    use crate::ir::{self, irgen::IRGenerator, DeclFuncStmt, IRExpr, IRStmt, IRTypedIdent, LabelStmt, Literal, ReturnStmt, INT8_T};
    ...
    fn test_ir_to_string() {
        ...
        assert_eq!(code_gen.stream().to_string(), "'myLabel: {\n    ret l{\"test\"}\n}")
    }
}
